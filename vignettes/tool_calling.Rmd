...
wflow_tool |> 
  process_text_prompts(text_prompts = "Tell me what recent disasters have happened in Mexico, as well as the date of their occurence") |> 
...
wflow_no_tool |> 
  process_text_prompts("Tell me what recent disasters have happened in Mexico, as well as the date of their occurence") |> 
  pull_final_text_answer()
...
myflow_math |>
  process_text_prompts("Can you help me solve this math problem? How much is 1321212* 3 , and dividing this whole thing by 7 in the end?") |>
  pull_final_text_answer()
